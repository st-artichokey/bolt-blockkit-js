# Contributing to Retro Recap App
...
Tests use the Node.js built-in test runner with `esmock` for mocking Bolt dependencies. Look at existing test files for patterns.
...
2. Add the element to the appropriate listener (modal builder, App Home, or message blocks)
